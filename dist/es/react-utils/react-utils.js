...
var checkPropTypes_1 = checkPropTypes;var react_development = createCommonjsModule(function (module, exports) {
...
var Map$1 = getNative(root, 'Map');/* Built-in method references that are verified to be native. */
...
const isFunction$2 = arg=>typeof arg==='function';
...
const ifElse = (pred,T,F=identity$2)=>(...args)=>(pred(...args) ? T : F)(...args);
...
const pget = cond$1( // polymorphic get
  ...
  [isPlainObject$1, obj=>target=>mo(f=>pget(f)(target))(obj)],
  [stubTrue$1,identity$2], // handles the function case
);
const pick=cond$1(
  [isArray$1,keys=>obj=>transToSame((o,k)=>o[k]=obj[k])(keys)],
  [isString$1,k=>pick([k])],
  [isFunction$2,filterToSame],
...
const [Div,Span,Ul,Ol,Dt,Dd,Dl,Article,P$1,H1,H2,H3,H4,H5,H6,Li,Input,A$1,Label,Pre,Textarea] = (
             'div,span,ul,ol,dt,dd,dl,article,p,h1,h2,h3,h4,h5,h6,li,input,a,label,pre,textarea'
             .split(',').map(toHookComposer));
const [Button,Img,Header,Svg,G$1,Path,Polyline,Rect,Line,Circle,Text,Table,Td,Th,Tr] = (
...
const useObservable = (observable, initialValue) => {
  ...
  return value;
};export{A$1 as A,Article,Button,Circle,Dd,Div,Dl,Dt,G$1 as G,H1,H2,H3,H4,H5,H6,Header,Img,Input,Label,Li,Line,Ol,P$1 as P,Path,Polyline,Pre,Rect,Span,Svg,Table,Td,Text,Textarea,Th,Tr,Ul,eventFactory,isHookComposer,onChange,onClick,onInput,onKeyPress,onKeydown,onKeyup,onSubmit,style,toHookComposer,useObservable};