...
var indexSchema = memoize$1(schema=>{
...
function matchesProperty(path, srcValue) {
  return baseMatchesProperty(path, baseClone(srcValue, CLONE_DEEP_FLAG$2));
...
const schemaToStateOpsMapper=(
  ...
  return transToObject((acc,actionNormalizer,dName)=>{
    const opFns=transToObject((o,opFn,OP)=>o[`${OP}_${dName.toUpperCase()}`]=opFn(identity$1))(ops);
