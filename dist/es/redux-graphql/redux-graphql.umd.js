(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports):typeof define==='function'&&define.amd?define(['exports'],f):(g=typeof globalThis!=='undefined'?globalThis:g||self,f(g.ReduxGraphql={}));}(this,(function(exports){'use strict';// curry/compose/pipe, for later fns
let compose;
const identity=x=>x;
...
}var parser=/*#__PURE__*/Object.freeze({__proto__:null,parse: parse,parseValue: parseValue,parseType: parseType});function getCjsExportFromNamespace (n) {
	return n && n['default'] || n;
}var parser$1 = getCjsExportFromNamespace(parser);var parse$1 = parser$1.parse;
...
};exports.gql=src;exports.querySelectorToUseLeafQuery=querySelectorToUseLeafQuery;exports.querySelectorToUseQuery=querySelectorToUseQuery;exports.schemaToQuerySelector=schemaToQuerySelector;exports.schemaToReducerMap=schemaToReducerMap;Object.defineProperty(exports,'__esModule',{value:true});})));