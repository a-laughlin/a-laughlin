...
/***/ "./src/style-string-to-object/style-string-to-object.js":
/*!**************************************************************!*\
  !*** ./src/style-string-to-object/style-string-to-object.js ***!
  \**************************************************************/
/*! namespace exports */
/*! export default [provided] [maybe used (runtime-defined)] [usage prevents renaming] */
/*! export styleStringToObj [provided] [maybe used (runtime-defined)] [usage prevents renaming] */
...
/* harmony export */   "styleStringToObj": () => /* binding */ styleStringToObj,
...
const styleStringToObj = (()=>{
  ...
  const valSetterFactory = fn=>(...keys)=>lodash_flow__WEBPACK_IMPORTED_MODULE_1___default()(fn,sz=>keys.reduce((o,k)=>{o[k]=sz;return o;},{}));
  ...
  const parser = (str)=>{
    try{
      ...
      __webpack_require__.g.console && console.warn(`invalid style: "${str}". See style-string-to-object.test.js for correct syntax.`);
      return {};
    }
  };
  ...
  const getCachedOrParseThenCache = (str)=>{
    ...
    return cache[str]||(cache[str]=lodash_merge__WEBPACK_IMPORTED_MODULE_0___default()({},...str.split(styleSeparator).filter(s=>!!s).map(s=>cache[s]||(cache[s]=parser(s)))));
  }
  ...
  const prefixes ={
    ...
    transx:lodash_flow__WEBPACK_IMPORTED_MODULE_1___default()(getSizeVal,sz=>({transform:`translateX(${sz})`})),
    transy:lodash_flow__WEBPACK_IMPORTED_MODULE_1___default()(getSizeVal,sz=>({transform:`translateY(${sz})`})),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (styleStringToObj);
...
/******/ 	return __webpack_require__("./src/style-string-to-object/style-string-to-object.js");
/******/ })()
;
});
//# sourceMappingURL=style-string-to-object.umd.js.map